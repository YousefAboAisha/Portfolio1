$(document).ready(function () {
    ...
    $(".nav-bar i").click(function () {
        ...
        // $(".nav-bar i:nth-child(2)").css("display", "block")
        $(".side-bar").toggleClass("activeNav");
        $(".nav-bar i").toggle();
        // $(".nav-bar i:nth-child(2)").click(function () {
        //     $(this).css("display", "none")
        //     $(".nav-bar i:nth-child(1)").css("display", "block")
        //     $("side-bar").toggleClass("activeNav");
    ...
    // if ($(window).width >= 890) {
    //     $("nav-bar i:nth-child(1)").css("display", "none")
    // }
